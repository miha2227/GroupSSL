...
def setup_data(args):
    ...
    train_labeled_set, train_unlabeled_set, val_set, test_set = dataset.get_cifar100('./data', args.n_labeled,
...
def train_GroupSSL_with_LR_Schedule(args, logEnabled=True, isOptuna=False):  # Objective wrapper for Optuna to tune.
    ...
    train_criterion = SemiLoss(args=args, n_classes=100)
    ...
    for epoch in range(args.epochs):
        ...
        train_loss, train_loss_x, train_loss_nll, train_loss_ce, train_loss_u = train(labeled_trainloader,
                                                                                      ...
                                                                                      epoch, use_cuda, n_classes=n_classes,
                                                                                      args=args,
