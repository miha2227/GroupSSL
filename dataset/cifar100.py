...
def get_cifar100(root, n_labeled,
    ...
    train_labeled_idxs, train_unlabeled_idxs, val_idxs = train_val_split(base_dataset.targets, int(n_labeled/N_CLASSES))
...
def train_val_split(labels, n_labeled_per_class):
    ...
    for i in range(N_CLASSES):
        ...
        train_unlabeled_idxs.extend(idxs[n_labeled_per_class:-50])  # 500->50
        val_idxs.extend(idxs[-50:])  # 500->50
